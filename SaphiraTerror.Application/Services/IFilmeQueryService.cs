using SaphiraTerror.Application.DTOs;   // Importa DTOs de aplicação; aqui usaremos FilmeDto como projeção para a UI/API.
using SaphiraTerror.Application.Filters; // Importa o filtro/paginação (FilmeFilter) para padronizar critérios de busca.

namespace SaphiraTerror.Application.Services; // Camada Application: serviços orquestram casos de uso sem dependências de Infra concretas.
