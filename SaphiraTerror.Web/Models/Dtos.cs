namespace SaphiraTerror.Web.Models; // Namespace da camada Web (modelos usados pelas Views/Controllers).
...
public record FilmeDto(
    ...
    string ClassificacaoNome);    // Nome da classificação (exibição).
